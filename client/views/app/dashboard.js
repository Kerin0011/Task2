...
<header class="border-b border-blue-100 bg-white/90 backdrop-blur">
      <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <nav class="hidden gap-3 md:flex">
          ...
          <button id="logout-button" class="cursor-pointer rounded-full px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50">Logout</button>
        </nav>
      </div>
    </header>
    ...
    <main class="mx-auto max-w-6xl px-6 py-10">
      <section class="rounded-[2rem] bg-blue-600 px-8 py-10 text-white shadow-xl shadow-blue-100">
        <p class="text-sm font-semibold uppercase tracking-[0.3em] text-blue-100">Dashboard principal</p>
          <p id="dashboard-username" class="mt-3 text-4xl font-black tracking-tight">Bienvenida, Ana.</p>
      ...
      <section class="mt-8 grid gap-4 md:grid-cols-3">
        <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
          ...
          <p id="dashboard-active-count" class="mt-3 text-4xl font-black text-blue-700">12</p>
        </article>
        <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
          <p class="text-sm text-slate-500">Completadas</p>
          <p id="dashboard-completed-count" class="mt-3 text-4xl font-black text-blue-700">28</p>
        </article>
        <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
          <p class="text-sm text-slate-500">Pendientes hoy</p>
          <p id="dashboard-due-count" class="mt-3 text-4xl font-black text-blue-700">4</p>
        </article>
      </section>
...
export const dashboardBodyClass = `min-h-screen bg-sky-50 text-slate-800`;
