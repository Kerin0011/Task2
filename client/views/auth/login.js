      ...
      <section class="flex items-center justify-center px-6 py-10">
        <div class="w-full max-w-xl rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70">
          ...
          <form id="login-form" class="mt-8 grid gap-5">
            ...
            <button id="login-submit" type="submit" class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500">
              Entrar al dashboard
            </button>
          </form>
        </div>
...
export const loginBodyClass = `min-h-screen bg-gradient-to-b from-sky-50 via-white to-blue-100 text-slate-800`;
