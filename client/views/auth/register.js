        ...
        <div class="w-full max-w-xl rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70">
          <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
              <button id="register-back" class="rounded-full border border-blue-200 px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50">Atrás</button>
          ...
          <form id="register-form" class="mt-8 grid gap-5">
            ...
            <button id="register-submit" type="submit" class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500">
              Registrarme
            </button>
          </form>
        </div>
...
export const registerBodyClass = `min-h-screen bg-gradient-to-b from-sky-50 via-white to-blue-100 text-slate-800`;
